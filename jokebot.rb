...
#Variables
commands = "!commands, !joke, !thanks, !lol, !yes, !no, !yep, !nice, !wut, !happybirthday <Name>, !howtoplaystarcraft, !howtogetredditkarma, !goodbot, !badbot, !whatdidyousay, !tastefullyracist, !blackpeople, !source, !ping"
...
tastefullyracist = ["File.open('media/tastefully-racist/1.gif')", "File.open('media/tastefully-racist/2.gif')", "File.open('media/tastefully-racist/3.gif')", "File.open('media/tastefully-racist/4.gif')", "File.open('media/tastefully-racist/5.gif')"]
...
bot.message(with_text: '!yep') do |event|
...
bot.message(with_text: '!tastefullyracist') do |event|
  event.attach_file(eval tastefullyracist.sample(10).pop) #I shouldnt eval strings, but I'll fix that later...
