...
bot = Discordrb::Commands::CommandBot.new token: '<TOKEN HERE>', client_id: CLIENT_ID_HERE, prefix: '!'

#Variables
commands = "!commands, !joke, !thanks, !lol, !yes, !no, !yep, !nice, !wut, !happybirthday [Name],!howtoplaystarcraft, !howtogetredditkarma, !goodbot, !badbot, !whatdidyousay, !blackpeople, !source, !ping"
